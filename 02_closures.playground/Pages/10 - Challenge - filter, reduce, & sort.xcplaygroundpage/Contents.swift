 ...
 */
let names = ["Jan", "Ossi", "Flecki", "Steve", "Tim"]
 ...
 */
names.filter { $0.count > 3 }.reduce("") { $0 + $1 }
/*:
 ...
 */
let namesAndAges = ["Jan": 31, "Ossi": 2, "Flecki": 4, "Steve": 56, "Tim": 62]
let peopleUnder18 = namesAndAges.filter { $0.value < 18 }
/*:
 ...
 */
let peopleNamesOver18 = namesAndAges.filter { $0.value > 18 }.map { $0.key }
